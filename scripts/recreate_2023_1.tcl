...
proc create_hier_cell_Processing_Subsystem { parentCell nameHier } {
  ...
  global script_dir
  set preset_file [file join $script_dir ultrazed_preset.tcl]
  if {[file exists $preset_file]} {
    puts "Applying UltraZed preset from $preset_file..."
    source $preset_file
    set preset_config [apply_preset $zynq_ultra_ps_e_0]
    set_property -dict $preset_config $zynq_ultra_ps_e_0
  } else {
    puts "WARNING: UltraZed preset file not found at $preset_file"
